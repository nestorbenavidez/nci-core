...
class FinancialInstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create financial_institution" do
    assert_difference('FinancialInstitution.count') do
      post financial_institutions_url, params: { financial_institution: { apr: @financial_institution.apr, name: @financial_institution.name } }
    end
  ...
  test "should update financial_institution" do
    patch financial_institution_url(@financial_institution), params: { financial_institution: { apr: @financial_institution.apr, name: @financial_institution.name } }
