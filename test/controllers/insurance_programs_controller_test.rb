...
class InsuranceProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance_program" do
    assert_difference('InsuranceProgram.count') do
      post insurance_programs_url, params: { insurance_program: { broker_fee: @insurance_program.broker_fee, inspection_fee: @insurance_program.inspection_fee, name: @insurance_program.name, surplus_fee: @insurance_program.surplus_fee, surplus_tax: @insurance_program.surplus_tax } }
    end
  ...
  test "should update insurance_program" do
    patch insurance_program_url(@insurance_program), params: { insurance_program: { broker_fee: @insurance_program.broker_fee, inspection_fee: @insurance_program.inspection_fee, name: @insurance_program.name, surplus_fee: @insurance_program.surplus_fee, surplus_tax: @insurance_program.surplus_tax } }
