...
class LimitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create limit" do
    assert_difference('Limit.count') do
      post limits_url, params: { limit: { insurance_program: @limit.insurance_program, name: @limit.name } }
    end
  ...
  test "should update limit" do
    patch limit_url(@limit), params: { limit: { insurance_program: @limit.insurance_program, name: @limit.name } }
