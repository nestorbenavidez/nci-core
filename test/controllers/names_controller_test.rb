...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { apr: @name.apr, insurance_program: @name.insurance_program } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { apr: @name.apr, insurance_program: @name.insurance_program } }
