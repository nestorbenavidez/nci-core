...
class UsStatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create us_state" do
    assert_difference('UsState.count') do
      post us_states_url, params: { us_state: { initials: @us_state.initials, name: @us_state.name } }
    end
  ...
  test "should update us_state" do
    patch us_state_url(@us_state), params: { us_state: { initials: @us_state.initials, name: @us_state.name } }
